...
**This application is deployed on Render for the backend only. The .env files have been copied on vercel and have *NOT* been pushed to git, you'll need to email me to request it.**
